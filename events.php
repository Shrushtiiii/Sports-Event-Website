...
<body>
  ...
  <div class="site-wrap">
    ...
    <div class="site-section bg-dark" id="here">
       <h3 align="Center" style="color: red;">You can see list of all the events below</h3></br></br>
      <?php
        
      $con=mysqli_connect("localhost","root","1234","sports");
      $r=mysqli_query($con,"select * from eventlist");
      
      while($row=mysqli_fetch_array($r))
      { ?>        
        <h3 align="Center"> <?php  echo $row[0];?>: Event Name: <?php  echo $row[1];?></h3><a  href="eventdetails.php?a=<?php echo $row[0];?>"><h6 align="Center"> >> More Details</h6>
        </a>
<?php
      }
